  ...
  <div class="page profile-box">
    <section class="section-name-picture">
      <div class="set-picture">
        ...
        <div class="change-picture">
          ...
          <a class="change-picture" @click.prevent="openPicturePanel"
            >變更大頭貼照</a
          >
        </div>
      </div>
      ...
      <form class="form-profile" action="">
        <div class="form-item">
          ...
          <section class="section-name">
            <input
              :class="{ notAllow: !isChangeUserName, allow: isChangeUserName }"
              type="text"
              name="user"
            ...
            <a
              ...
              @click.prevent="isChangeUserName = !isChangeUserName"
            >
        ...
        <div class="btn-group">
          ...
          <button class="deactive-btn" @click.prevent="deactivatedAccount">
            暫時停用我的帳號
          </button>
        </div>
      </form>
    ...
    <section class="confirm-panel" v-if="isOpenGenderPanel">
      <div class="gender-box">
        ...
        <button class="closeGenderBtn" @click.prevent="pickGenderDone">
          完成
        </button>
      </div>
    </section>
    <section class="confirm-panel" v-if="isGenderChange">
      <div class="gender-no-save-confirm">
        ...
        <div class="check-btn">
          <button
            class="yes-btn"
            @click.prevent="close_gender_and_confirm_Panel"
          >
            是
          </button>
          <button class="no-btn" @click.prevent="isGenderChange = false">
            否
          </button>
        </div>
      </div>
  ...
  setup() {
    ...
    watch(
      ...
      newV => {
        ...
        watchGenderChange =
          newV == "" ? false : newV !== tempGender ? true : false;
      }
    );
